 ...
 */
 export function createScoreBoard() {
    const objPlayersScores = {
      'The Best Ever' : 1000000
    }
  
    return objPlayersScores;
  }
  ...
  export function updateScore(scoreBoard, player, points) {
    if (scoreBoard.hasOwnProperty(player)){
      ...
      scoreBoard[player] = currentPoints;
    }
  ...
  export function normalizeScore(params) {
    let notNormalizedPoints = params.score;
    let normalizedPoints = params.normalizeFunction(notNormalizedPoints);
